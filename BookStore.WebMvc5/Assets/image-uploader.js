...
(function ($) {
    $.fn.imageUploader = function (options) {
        ...
        let defaults = {
            ...
            label: 'Nhấn vào đây để tải nhiều ảnh'
        };
        ...
        let createContainer = function () {
            ...
            let $container = $('<div>', { class: 'image-uploader' }),
                ...
                $i = $('<i>', { class: 'fa fa-cloud', text: '' }).appendTo($textContainer),
        ...
        let createImg = function (src, id) {
            ...
            let $container = $('<div>', { class: 'uploaded-image' }),
                ...
                $button = $('<button>', { class: '' }).appendTo($container),

                // Create the delete icon
                $i = $('<ion-icon name="close-outline"></ion-icon>').appendTo($button);
        ...
        let setPreview = function ($container, files) {
            ...
            $(files).each(function (i, file) {
                ...
                AjaxFile("/OpsPlan/UploadImage", window.objAjax,
                    function (response) {
                        dataTransfer.items.add(file);
                        $uploadedContainer.append(createImg(response.data, $(".uploaded-image").length + dataTransfer.items.length - 1));
                    });
            });
