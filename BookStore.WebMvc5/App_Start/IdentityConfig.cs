...
namespace BookStore.Website
{
    ...
    {
        public ApplicationUserStore(BookStoreDbContext context)
            : base(context)
        {
        }
    }
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<IdentityRole>(context.Get<BookStoreDbContext>()));
        }
    }
    ...
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new ApplicationUserStore(context.Get<BookStoreDbContext>()));
